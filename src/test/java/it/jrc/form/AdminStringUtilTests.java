...
public class AdminStringUtilTests {
	...
	public static Collection<Object[]> generateData() {
		return Arrays.asList(new Object[][] { { "lowercase", "Lowercase" }, { "lowerCamelCase", "Lower Camel Case" },
				{ "UpperCamelCase", "Upper Camel Case" }, { "Upper1Camel1Case1", "Upper 1 Camel 1 Case 1" }, });
	}
